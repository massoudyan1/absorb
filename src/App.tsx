  ...
  return (
    <div className="pt-32 pb-24 px-8">
      ...
      <header className="mb-20 flex flex-col md:flex-row justify-between items-end gap-8">
        <div>
          <h1 className="font-headline text-5xl md:text-4xl font-black tracking-[-0.05em] uppercase mb-4">in silence we hear</h1>
          <p className="font-label text-xs uppercase tracking-widest text-outline">Collections of Winter-Spring 2026</p>
        </div>
  ...
  return (
    <footer className="bg-transparent flex flex-col md:flex-row justify-between items-center w-full px-8 py-12 border-t-4 border-[#919191]">
      ...
      <div className="flex gap-12">
        <a className="font-body uppercase text-[0.6875rem] tracking-widest text-[#474747] hover:text-white transition-none" href="#">PRIVACY</a>
        <a className="font-body uppercase text-[0.6875rem] tracking-widest text-[#474747] hover:text-white transition-none" href="#">TERMS</a>
        <a className="font-body uppercase text-[0.6875rem] tracking-widest text-[#474747] hover:text-white transition-none" href="#">COORDINATES</a>
        <a className="font-body uppercase text-[0.6875rem] tracking-widest text-[#474747] hover:text-white transition-none" href="#">DISCLAIMER</a>
      </div>
